...
namespace BusinessLayer.Dictionaties
{
	public class DirectiveType : StaticDictionary
	{
		...
		/// </summary>
		private static List<DirectiveType> _Items = new List<DirectiveType>();
		#endregion
		...
		/// </summary>
		public static List<DirectiveType> Items
		{
			get { return _Items; }
		}
		#endregion
		...
		public DirectiveType(int itemId, string shortName, string fullName, string commonName)
		{
			ItemId = itemId;
			ShortName = shortName;
			FullName = fullName;
