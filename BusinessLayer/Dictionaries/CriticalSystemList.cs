...
namespace BusinessLayer.Dictionaties
{
	public class CriticalSystemList : StaticDictionary
	{
		...
		/// </summary>
		private static List<CriticalSystemList> _Items = new List<CriticalSystemList>();
		#endregion
		...
		/// <returns></returns>
		public static CriticalSystemList GetItemById(int directiveTypeId)
		{
		...
		/// </summary>
		public static List<CriticalSystemList> Items
		{
			get { return _Items; }
		}
		#endregion
		...
		public CriticalSystemList(int itemId, string shortName, string fullName, string commonName)
		{
			ItemId = itemId;
			ShortName = shortName;
			FullName = fullName;
