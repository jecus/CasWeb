...
namespace BusinessLayer.Dictionaties
{
	public class MpdCategory : StaticDictionary
	{
		...
		/// </summary>
		private static List<MpdCategory> _Items = new List<MpdCategory>();
		#endregion
		...
		/// </summary>
		public static List<MpdCategory> Items
		{
			get
			{
				return _Items;
		...
		/// <returns></returns>
		public static MpdCategory GetItemById(int conditionStateId)
		{
		...
		public MpdCategory(int itemId, string shortName, string fullName)
		{
			ItemId = itemId;
			ShortName = shortName;
			FullName = fullName;
