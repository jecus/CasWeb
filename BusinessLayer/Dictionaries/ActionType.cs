...
namespace BusinessLayer.Dictionaties
{
    public class ActionType : StaticDictionary
    {
        ...
        /// </summary>
        private static List<ActionType> _Items = new List<ActionType>();
        #endregion
        ...
        /// <returns></returns>
        public static ActionType GetItemById(int maintenanceTypeId)
        {
        ...
        /// </summary>
        public static List<ActionType> Items
        {
            get
            {
                return _Items;
        ...
        public ActionType(int itemId, string shortName, string fullName)
        {
            ItemId = itemId;
            ShortName = shortName;
            FullName = fullName;
