...
namespace BusinessLayer.Dictionaties
{
    public class FamilyStatus : StaticDictionary
    {
        ...
        /// </summary>
        private static List<FamilyStatus> _Items = new List<FamilyStatus>();
        #endregion
        ...
        /// <returns></returns>
        public static FamilyStatus GetItemById(int maintenanceTypeId)
        {
        ...
        /// </summary>
        public static List<FamilyStatus> Items
        {
            get
            {
                return _Items;
        ...
        public FamilyStatus(int itemId, string shortName, string fullName)
        {
            ItemId = itemId;
            ShortName = shortName;
            FullName = fullName;
