...
namespace BusinessLayer.Dictionaties
{
	public class MaintenanceDirectiveTaskType : StaticDictionary
	{
		...
		/// </summary>
		private static List<MaintenanceDirectiveTaskType> _Items = new List<MaintenanceDirectiveTaskType>();
		#endregion
		...
		/// <returns></returns>
		public static MaintenanceDirectiveTaskType GetItemById(int directiveTypeId)
		{
		...
		/// </summary>
		public static List<MaintenanceDirectiveTaskType> Items
		{
			get { return _Items; }
		}
		#endregion
		...
		public MaintenanceDirectiveTaskType(int itemId, string shortName, string fullName, string commonName)
		{
			ItemId = itemId;
			ShortName = shortName;
			FullName = fullName;
