...
namespace BusinessLayer.Dictionaties
{
	public class ComponentRecordType : StaticDictionary
	{
		...
		/// </summary>
		private static List<ComponentRecordType> _Items = new List<ComponentRecordType>();
		#endregion
		/*
		...
		/// </summary>
		public static List<ComponentRecordType> Items
		{
			get
			{
				return _Items;
		...
		*/
		...
		public ComponentRecordType(int itemID, string shortName, string fullName, string commonName)
		{
			ItemId = itemID;
			ShortName = shortName;
			FullName = fullName;
