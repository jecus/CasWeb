...
namespace BusinessLayer.Dictionaties
{
    public class Measure : StaticDictionary
    {
        ...
        /// </summary>
        private static List<Measure> _Items = new List<Measure>();
		#endregion
		...
		*/
		...
		/// </summary>
		public static List<Measure> Items
        {
            get
            {
                return _Items;
    ...
    public class MeasureCategory : StaticDictionary
    {
        ...
        /// Содержит все элементы
        /// </summary>
        private static List<MeasureCategory> _Items = new List<MeasureCategory>();
        #endregion
        ...
        /// Возвращает список элементов коллекции
        /// </summary>
        public static List<MeasureCategory> Items
        {
            get
            {
                return _Items;
