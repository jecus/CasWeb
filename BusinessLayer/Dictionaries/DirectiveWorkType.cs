...
namespace BusinessLayer.Dictionaties
{
	public class DirectiveWorkType : StaticDictionary
	{
		...
		/// </summary>
		private static List<DirectiveWorkType> _Items = new List<DirectiveWorkType>();
		#endregion
		...
		/// </summary>
		public static List<DirectiveWorkType> Items
		{
			get { return _Items; }
		}
		#endregion
		...
		public DirectiveWorkType(int itemId, String shortName, String fullName, String commonName)
		{
			ItemId = itemId;
			ShortName = shortName;
			FullName = fullName;
