...
namespace BusinessLayer.Dictionaties
{
	public class Skill : StaticDictionary
	{
		...
		/// </summary>
		private static List<Skill> _Items = new List<Skill>();
		#endregion
		...
		/// </summary>
		public static List<Skill> Items
		{
			get
			{
				return _Items;
		...
		/// <returns></returns>
		public static Skill GetItemById(int conditionStateId)
		{
		...
		public Skill(int itemId, string shortName, string fullName)
		{
			ItemId = itemId;
			ShortName = shortName;
			FullName = fullName;
