...
namespace BusinessLayer.Dictionaties
{
	public class DirectiveStatus : StaticDictionary
	{
		...
		/// </summary>
		private static List<DirectiveStatus> _Items = new List<DirectiveStatus>();
		#endregion
		/*
         * Реализация
         */
		...
		/// </summary>
		public static List<DirectiveStatus> Items
		{
			get
			{
				return _Items;
		...
		public DirectiveStatus(int recordTypeId, string shortName, string fullName)
		{
			ShortName = shortName;
			FullName = fullName;
			ItemId = recordTypeId;
		...
		/// <returns></returns>
		public static DirectiveStatus GetItemById(int conditionStateId)
		{
