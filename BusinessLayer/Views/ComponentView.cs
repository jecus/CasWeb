...
namespace BusinessLayer.Views
{
	public class ComponentView : BaseView
	{
		...
		public string DescriptionString => Model != null ? Model.Description : Description;
		...
		public string ATAChapterString => !IsBaseComponent ? (Model != null ? Model.AtaChapter?.ToString() : ATAChapter?.ToString()) : ATAChapter?.ToString();
		...
		public string TransferDateString => Model != null ? TransferRecords?.GetLast()?.TransferDate.ToUniversalString() : " ";
		public string PositionString => Model != null ? TransferRecords?.GetLast()?.Position.ToUpper() : " ";
