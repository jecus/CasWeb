	...
	public static class Converter
	{
		...
		public static DirectiveView ToBlView(this Directive entity)
		{
			return new DirectiveView()
			{
				...
				BaseComponentId = entity.ComponentId ?? -1,
		...
		public static ComponentModelView ToBlView(this ComponentModel componentModel)
		{
			return new ComponentModelView()
			{
				...
				Manufacturer = componentModel.Manufacturer,
				CostNew = componentModel.CostNew,
				Reference = componentModel.Reference,
				CostOverhaul = componentModel.CostOverhaul,
				CostServiceable = componentModel.CostServiceable,
				Measure = componentModel.Measure,
				Remarks = componentModel.Remarks,
		...
		public static ComponentView ToBlView(this Component comp)
		{
			return new ComponentView()
			{
				...
				Model = comp.Model != null ?  (IProductView) comp.Model?.ToBlView() : comp.Product?.ToBlView(),
				PartNumber = comp.PartNumber,
				Description = comp.Description,
				SerialNumber = comp.SerialNumber,
				BatchNumber = comp.BatchNumber,
		...
		public static NonRoutineJob ToEntity(this NonRoutineJobView view)
		{
		...
		public static NonRoutineJobView ToBlView(this NonRoutineJob entity)
		{
			return new NonRoutineJobView
			{
				Id = entity.Id,
				IsDeleted = entity.IsDeleted,
		...
		public static List<NonRoutineJobView> ToBlView(this IEnumerable<NonRoutineJob> entity)
		{
			return new List<NonRoutineJobView>(entity.Select(i => i.ToBlView()));
		}

		public static List<NonRoutineJob> ToEntity(this IEnumerable<NonRoutineJobView> view)
		{
			return new List<NonRoutineJob>(view.Select(i => i.ToEntity()));
		}
		...
		public static MaintenanceCheck ToEntity(this MaintenanceCheckView view)
		{
			return new MaintenanceCheck
			{
				Id = view.Id,
				IsDeleted = view.IsDeleted,
				Name = view.Name,
		...
		public static MaintenanceCheckView ToBlView(this MaintenanceCheck entity)
		{
			return new MaintenanceCheckView
			{
				Id = entity.Id,
				IsDeleted = entity.IsDeleted,
				Name = entity.Name,
		...
		public static List<MaintenanceCheckView> ToBlView(this IEnumerable<MaintenanceCheck> entity)
		{
			return new List<MaintenanceCheckView>(entity.Select(i => i.ToBlView()));
		}

		public static List<MaintenanceCheck> ToEntity(this IEnumerable<MaintenanceCheckView> view)
		{
			return new List<MaintenanceCheck>(view.Select(i => i.ToEntity()));
		}

		#endregion

		#region MaintenanceCheckType

		public static MaintenanceCheckType ToEntity(this MaintenanceCheckTypeView view)
		{
		...
		public static MaintenanceCheckTypeView ToBlView(this MaintenanceCheckType entity)
		{
			return new MaintenanceCheckTypeView
			{
				Id = entity.Id,
				IsDeleted = entity.IsDeleted,
				Name = entity.Name,
		...
		public static List<MaintenanceCheckTypeView> ToBlView(this IEnumerable<MaintenanceCheckType> entity)
		{
			return new List<MaintenanceCheckTypeView>(entity.Select(i => i.ToBlView()));
		}

		public static List<MaintenanceCheckType> ToEntity(this IEnumerable<MaintenanceCheckTypeView> view)
		{
			return new List<MaintenanceCheckType>(view.Select(i => i.ToEntity()));
		}
